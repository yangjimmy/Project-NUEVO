## GPIO Pin Assignment Table [Rev. A]
...
| 11 (PWM) | LED_RED | Discrete red LED | No | User/TLV-controlled |
...
| 42 | NEOPIXEL_DIN | WS2812B RGB LED Data | No | Automatic system-state indicator |
| 43 | M1_IN2 | Motor 1 IN2 | No | Default wheel direction |
| 44 (PWM) | LED_GREEN | Discrete green LED | No | User/TLV-controlled |
